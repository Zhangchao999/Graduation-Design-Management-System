			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="${pageContext.request.contextPath}/teacher/modifyInfo">修改个人信息</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/teacher/modifyPassword">修改密码</a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="${pageContext.request.contextPath}/teacher/uploadThesisTitle">上传课题</a>
							</li>
							<li>
								<a href="${pageContext.request.contextPath}/teacher/thesisResult">课题结果</a>
							</li>
						</ul>
					</li>
				</ul>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							<li>
								<a href="${pageContext.request.contextPath}/teacher/studentManage">查看学生信息</a>
							</li>
						</ul>
					</li>
				</ul>
